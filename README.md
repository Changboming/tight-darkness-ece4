...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/tight-darkness-ece4
```

A live public deployment of this template is available at [https://tight-darkness-ece4.templates.workers.dev](https://tight-darkness-ece4.templates.workers.dev)
